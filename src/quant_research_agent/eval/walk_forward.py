...
from quant_research_agent.strategy.base import Strategy
from quant_research_agent.types import MarketEvent
...
def walk_forward(
    ...
    from quant_research_agent.research.runner import run_backtest  # local import: avoid import cycle
