...
from quant_research_agent.agent.journal import Journal, JournalEntry
from quant_research_agent.agent.loop import AgentResult, ResearchAgent
from quant_research_agent.config import QuantResearchAgentConfig
from quant_research_agent.data import load_dataset
from quant_research_agent.eval.protocol import Candidate, EvaluationReport, OutOfSampleEvaluator
from quant_research_agent.integrity import dataset_fingerprint
from quant_research_agent.models.cache import ResponseCache
from quant_research_agent.models.gateway import ModelGateway
from quant_research_agent.obs.ledger import CostLedger
from quant_research_agent.obs.store import ExperimentStore
from quant_research_agent.obs.tracing import span
...
class Orchestrator:
    def __init__(self, config: QuantResearchAgentConfig) -> None:
        self.config = config
    ...
    async def run(self) -> RunSummary:
        ...
        sandbox = None
        if cfg.use_sandbox:
            from quant_research_agent.sandbox import build_sandbox
