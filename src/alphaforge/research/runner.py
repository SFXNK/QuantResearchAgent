...
Importable in-process *and* runnable as a module inside the sandbox:
    ...
    python -m alphaforge.research.runner --strategy strat.py \
...
from alphaforge.eval.metrics import Metrics, compute_metrics
from alphaforge.sim import Backtester
from alphaforge.strategy.base import Strategy, as_strategy_fn
from alphaforge.types import BacktestResult, EventType, MarketEvent, Side
