...
from alphaforge.config import EvalConfig, SimConfig
from alphaforge.data.dataset import Dataset
from alphaforge.strategy.baselines import baseline_strategies
...
class OutOfSampleEvaluator:
    ...
    def _baselines(self) -> tuple[dict[str, Metrics], float]:
        from alphaforge.research.runner import run_backtest  # local import: avoid cycle
    ...
    def evaluate(self, candidates: Sequence[Candidate]) -> EvaluationReport:
        from alphaforge.research.runner import load_strategy, run_backtest  # avoid cycle
