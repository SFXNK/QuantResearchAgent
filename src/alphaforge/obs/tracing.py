...
dependencies at runtime. Set ALPHAFORGE_TRACE=console to print spans, or wire
...
def configure_tracing() -> None:
    ...
    if os.environ.get("ALPHAFORGE_TRACE") == "console":
        provider.add_span_processor(SimpleSpanProcessor(ConsoleSpanExporter()))
    trace.set_tracer_provider(provider)
    _CONFIGURED = True


def get_tracer(name: str = "alphaforge"):  # noqa: ANN201
    configure_tracing()
